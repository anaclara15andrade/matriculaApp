...
export class EstruturaCurricular{
  codigo:string;
  status:string;
...
export class DisciplinaEstruturaCurricular{
  tipo:string;
  nivel:number;
...
export class DisciplinaHistoricoAcademico{
  status:string;
  mencao:string;
...
export class HistoricoAcademico{
  aluno:Aluno;
